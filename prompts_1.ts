...
export function buildCharacterSheetPrompt(params: {
  ...
  if (solo) {
    return [
      ...
      "If this character is an animal, draw a REAL animal of its species standing on ALL FOUR LEGS in natural side profile, with no clothing and no human posture. If this character is a human, they stand facing the viewer.",
