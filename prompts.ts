...
export function buildCharacterSheetPrompt(params: {
  ...
  return [
    ...
    solo
      ? "Children's picture-book character reference portrait: ONE single figure alone, centered on a plain white background, FULL BODY head-to-toe, large and clearly visible. A HUMAN faces the viewer standing; an ANIMAL is shown in SIDE PROFILE standing naturally on ALL FOUR LEGS."
    ...
    solo
      ? `DRAW EXACTLY THIS ONE CHARACTER AND NOBODY ELSE — a single figure, alone in the frame: ${params.characters}.`
